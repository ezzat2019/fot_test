...
import 'package:fot_test/ui/helper/DesignConfig.dart';
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        appBar: DesignConfig.setAppbar("Find Specialist", context, true) as PreferredSizeWidget
        ,
        ...
        Align(
          ...
          child: IntrinsicWidth(
            child: Container(
              ...
              child: SvgPicture.asset("assets/salon/svgimg/search.svg"),
            ),
          ),
        ),
      ],
            ...
            child: Stack(
              children: [
                SmartKitProConstant.isfirebaseimage
                    ...
                    : Image.asset(
                        DataConfig.sliderList[slidercurrimg]['img'],
                        height: 180,
                        width: double.maxFinite,
                        fit: BoxFit.fill,
                      ),
                  ...
                  child: CircleAvatar(
                    ...
                    child: ClipOval(
                      child: SmartKitProConstant.isfirebaseimage
                          ...
                          : Image.asset("assets/salon/user_2.jpg"),
                    ),
                  ),
                ),
                Positioned.fill(
                  ...
                  child: CircleAvatar(
                    ...
                    child: ClipOval(
                      child: SmartKitProConstant.isfirebaseimage
                          ...
                          : Image.asset("assets/salon/user_8.jpg"),
                    ),
                  ),
                ),
                Positioned.fill(
      ...
      Row(children: [
        Expanded(
          ...
          onTap: () {
            ...
            //           img: "assets/salon/shop_1.jpg",
            //       imgurl: 'https://firebasestorage.googleapis.com/v0/b/smartkit-8e62c.appspot.com/o/salonapp%2Fshop_1.jpg?alt=media&token=7b922a8b-bca8-4121-915f-c1561c8b78f6',
        ...
        Expanded(
          ...
          onTap: () {
            // Navigator.of(context).push(MaterialPageRoute(
            //     builder: (context) => SalonDetailPage(
            //       img: "assets/salon/shop_2.jpg",
            //       imgurl: 'https://firebasestorage.googleapis.com/v0/b/smartkit-8e62c.appspot.com/o/salonapp%2Fshop_2.jpg?alt=media&token=adcc28cf-7b87-404a-ac69-2ca50018022b',
                ...
                child: Stack(
                  children: [
                    ClipRRect(
                      ...
                      child: SmartKitProConstant.isfirebaseimage
                          ? OctoImage(
                              image: CachedNetworkImageProvider(DataConfig
                                  .recentlyvisitedlist[index]['imgurl']),
                              placeholderBuilder: OctoPlaceholder.blurHash(
                                  DataConfig.recentlyvisitedlist[index]
                                      ['hash']),
                              errorBuilder: OctoError.icon(color: Colors.black),
                              width: double.maxFinite,
                              height: iheight,
                          ...
                          : Image.asset(
                              DataConfig.recentlyvisitedlist[index]['img'],
                              width: double.maxFinite,
                              height: iheight,
                              fit: BoxFit.cover,
                            ),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          ...
                          SizedBox(width: 10),
                          SvgPicture.asset("assets/salon/svgimg/rating.svg"),
                          SizedBox(width: 8),
                          Text(
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          SvgPicture.asset("assets/salon/svgimg/location.svg"),
                          SizedBox(width: 8),
                          Expanded(
                            child: Text(
